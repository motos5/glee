...
$(function(){$(".header__btn").on("click",function(){$(".menu").toggleClass("menu--active")}),$(".detalis-tabs__item").on("click",function(t){t.preventDefault(),$(".detalis-tabs__item").removeClass("detalis-tabs__item--active"),$(this).addClass("detalis-tabs__item--active"),$(".detalis-tabs__content-item").removeClass("detalis-tabs__content-item--active"),$($(this).attr("href")).addClass("detalis-tabs__content-item--active")}),$(".top-slider__inner").slick({dots:!0,arrows:!1,fade:!0,autoplay:!0,autoplaySpeed:2e3}),$(".product-slide__thumb").slick({asNavFor:".product-slide__big",focusOnSelect:!0,slidesToShow:3,slidesToScroll:1,vertical:!0,draggable:!1}),$(".product-slide__big").slick({asNavFor:".product-slide__thumb",draggable:!1,arrows:!1,fade:!0}),$(".related__items").slick({slidesToShow:4,slidesToScroll:1,variableWidth:!0,prevArrow:'<button type="button" class="slick-prev"><img src="images/icons/next-arrow.svg" alt="prew arrow"></button>',nextArrow:'<button type="button" class="slick-next"><img src="images/icons/prew-arrow.svg" alt="next arrow"></button>'});var t=document.querySelector(".products__items"),e=document.querySelector(".design-new__items");t&&mixitup(".products__items",{selectors:{control:".filter1"}}),e&&mixitup(".design-new__items",{selectors:{control:".filter2"}}),$(".filtr-style, .detalis-item__content-input").styler({selectSearch:!1}),$(".catalog-content__btn").on("click",function(){$(".catalog-content__btn").removeClass("catalog-content__btn--active"),$(this).addClass("catalog-content__btn--active")}),$(".catalog-content__list").on("click",function(){$(".products__items").addClass("products__items--list"),$(".products__item").addClass("products__item--list"),$(".pagination").addClass("pagination--list")}),$(".catalog-content__grid").on("click",function(){$(".products__items").removeClass("products__items--list"),$(".products__item").removeClass("products__item--list"),$(".pagination").removeClass("pagination--list")}),$(".catalog-price__input").ionRangeSlider({type:"double",prefix:"$",step:.01,prettify_enabled:!0,onStart:function(t){$(".catalog-price__span-left").text(t.from),$(".catalog-price__span-right").text(t.to)},onChange:function(t){$(".catalog-price__span-left").text(t.from),$(".catalog-price__span-right").text(t.to)}}),$(".star").rateYo({starWidth:"10px",normalFill:"#d6d6d6",ratedFill:"#fc0",spacing:"6px",readOnly:!0,fullStar:!0})});