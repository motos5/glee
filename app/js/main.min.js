...
$(function(){$(".top-slider__inner").slick({dots:!0,arrows:!1,fade:!0,autoplay:!0,autoplaySpeed:2e3});var e=document.querySelector(".products__items"),t=document.querySelector(".design-new__items");e&&mixitup(".products__items",{selectors:{control:".filter1"}}),t&&mixitup(".design-new__items",{selectors:{control:".filter2"}})});